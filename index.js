...
const sessionOptions = {
  ...
  cookie: {
    //the session id is saved till the setted time in this cookie options
...
app.use("/testing", (req, res) => {
  const newListing = new Listing({
    ...
    image:
      "https://unsplash.com/photos/houses-surrounded-with-plants-vbSRUrNm3Ik",
    price: 3000,
    location: "Goa",
    country: "India",
  });
...
app.all("*", (req, res, next) => {
  //upr koi bhi orute me catch na homne pe yha aiyaga and error throw hoga jo next error handler me catch hoga
